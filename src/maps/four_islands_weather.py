...
class FourIslandsWeather:
    ...
    def initialize(self, rng, t=0):
        ...
        terrain_state = TerrainState(  # THIRD ISLAND
            energy_amt=terrain_state.energy_amt.at[frac : frac * 3, frac * 5 : frac * 7].set(sand.energy_amt),
            move_cost=terrain_state.move_cost.at[frac : frac * 3, frac * 5 : frac * 7].set(sand.move_cost),
            push_cost=terrain_state.push_cost.at[frac : frac * 3, frac * 5 : frac * 7].set(sand.push_cost),
            energy_gain=terrain_state.energy_gain.at[frac : frac * 3, frac * 5 : frac * 7].set(sand.energy_gain),
            message_cost=terrain_state.message_cost.at[frac : frac * 3, frac * 5 : frac * 7].set(sand.message_cost),
        ...
        terrain_state = TerrainState(  # FOURTH ISLAND
            energy_amt=terrain_state.energy_amt.at[frac * 5 : frac * 7, frac : frac * 3].set(sand.energy_amt),
            move_cost=terrain_state.move_cost.at[frac * 5 : frac * 7, frac : frac * 3].set(sand.move_cost),
            push_cost=terrain_state.push_cost.at[frac * 5 : frac * 7, frac : frac * 3].set(sand.push_cost),
            energy_gain=terrain_state.energy_gain.at[frac * 5 : frac * 7, frac : frac * 3].set(sand.energy_gain),
            message_cost=terrain_state.message_cost.at[frac * 5 : frac * 7, frac : frac * 3].set(sand.message_cost),
